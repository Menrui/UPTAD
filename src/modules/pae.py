...
from partialconv.partialconv2d import PartialConv2d
...
class AutoEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.enc51 = EncodeBlock(8 * dim, 16 * dim, use_bn=True)

        self.dec51 = DecodeBlock(16 * dim, 8 * dim, use_bn=True)
...
class EncodeBlock(nn.Module):
    def __init__(self, in_feature, out_future, use_bn):
        ...
        layers = []
        layers.append(PartialConv2d(in_feature, out_future, kernel_size=3, stride=1, padding=1, bias=use_bn))
